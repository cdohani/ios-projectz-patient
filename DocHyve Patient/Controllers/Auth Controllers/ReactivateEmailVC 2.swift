...
class ReactivateEmailVC: ParentViewController {
    ...
    override func viewDidLoad() {
        ...
        lblVerify.text = "Verify Email"
        lblDesc.text = "Enter the code we have sent by email to \(email)."
    ...
    func sendCode(){
        ...
        showLoadingView("")
        let endPoint =  Constants.URLs.sendSignVerificationCode
    ...
    func callVerifyApi(){
        ...
        showLoadingView("")
        let endPoint =  Constants.URLs.verifyPin
        AddDataService().addData(parameters:param,endPoint:endPoint,completion: { (success) in
